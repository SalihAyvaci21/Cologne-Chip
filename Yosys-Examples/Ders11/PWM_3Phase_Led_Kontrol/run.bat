...
:: ----------------------------
set TOP=led_brightness_3phase
set VLOG_SRC= src\debounce_ip_core.v src\pwm_generator.v src\led_brightness_3phase.v
set LOG=0
...
if "%1"=="sim_vlog" (
    "%IVL%" -o sim\iverilog\%TOP%_sim.vvp sim\iverilog\%TOP%_tb.v src\%TOP%.v src\debounce_ip_core.v src\pwm_generator.v
