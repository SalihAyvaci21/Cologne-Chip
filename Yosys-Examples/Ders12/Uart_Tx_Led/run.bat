...
:: ----------------------------
set TOP=top_uart_led
set VLOG_SRC=src\led_bounce_up_down_counter.v src\debounce_ip_core.v  src\transmitter.v src\top_uart_led.v
set LOG=0
...
if "%1"=="sim_vlog" (
    "%IVL%" -o sim\iverilog\%TOP%_sim.vvp sim\iverilog\%TOP%_tb.v src\%TOP%.v src\led_bounce_up_down_counter.v src\debounce_ip_core.v  src\transmitter.v 
