...
:: ----------------------------
set TOP=uart
set VLOG_SRC= src\receiver.v src\transmitter.v src\uart.v
set LOG=0
...
if "%1"=="sim_vlog" (
    "%IVL%" -o sim\iverilog\%TOP%_sim.vvp sim\iverilog\%TOP%_tb.v src\%TOP%.v src\receiver.v src\transmitter.v 
