...
:: ----------------------------
set TOP=uart_hesap_makinesi
set VLOG_SRC= src\receiver.v src\transmitter.v src\uart_hesap_makinesi.v 
set LOG=0
...
if "%1"=="sim_vlog" (
    "%IVL%" -o sim\iverilog\%TOP%_sim.vvp sim\iverilog\%TOP%_tb.v src\%TOP%.v src\receiver.v src\transmitter.v src\decimal_to_ascii.v src\ascii_to_decimal.v
