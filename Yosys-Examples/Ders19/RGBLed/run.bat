...
:: ----------------------------
set TOP=rgb_sequencer_top
set VLOG_SRC= src\rgb_sequencer_top.v src\RGBLed.v 
set LOG=0
...
if "%1"=="sim_vlog" (
    "%IVL%" -o sim\iverilog\%TOP%_sim.vvp sim\iverilog\%TOP%_tb.v src\%TOP%.v src\RGBLed.v
