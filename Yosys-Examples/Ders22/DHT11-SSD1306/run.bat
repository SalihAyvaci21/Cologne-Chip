...
:: ----------------------------
set TOP=Sensor_Display_Top
set VLOG_SRC= src\I2C.v src\OLED.v src/Frame_buffer.v src/debounce_ip_core.v src/Font_ROM.v src/db_dht11.v src/clk_div.v src/dht11_fsm.v src/top_dht11.v src/Sensor_Display_Top.v src/\bin2ascii.v
set LOG=0
...
if "%1"=="sim_vlog" (
    "%IVL%" -o sim\iverilog\%TOP%_sim.vvp sim\iverilog\%TOP%_tb.v src\%TOP%.v src\I2C.v src\OLED.v src/Simple_RAM.v
