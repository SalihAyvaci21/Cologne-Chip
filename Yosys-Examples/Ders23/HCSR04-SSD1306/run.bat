...
:: ----------------------------
set TOP=Top_OLED
set VLOG_SRC= src\I2C.v src\OLED.v src/Frame_buffer.v src/debounce_ip_core.v src\Top_OLED.v src/Font_ROM.v src/clk_div.v src/hc_sr04_fsm.v src/bcd_encoder.v
set LOG=0
